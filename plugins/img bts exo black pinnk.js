...
if (Config.WORKTYPE == 'private') {
    ...
    Asena.addCommand({pattern: 'bts ?(.*)', fromMe: true,  deleteCommand: false}, (async (message, match) => {
    ...
    Asena.addCommand({pattern: 'exo ?(.*)', fromMe: true,  deleteCommand: false}, (async (message, match) => {
    ...
    Asena.addCommand({pattern: 'blackpink ?(.*)', fromMe: true,  deleteCommand: false}, (async (message, match) => {
    ...
    Asena.addCommand({pattern: 'bts ?(.*)', fromMe: false}, (async (message, match) => {
   ...
   Asena.addCommand({pattern: 'exo ?(.*)', fromMe: false}, (async (message, match) => {
    ...
    Asena.addCommand({pattern: 'blackpink ?(.*)', fromMe: false}, (async (message, match) => {
