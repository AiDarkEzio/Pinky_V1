...
if (Config.WORKTYPE == 'private') {
    ...
    Asena.addCommand({pattern: 'logom4', fromMe: true, desc: EFFECT_DESC}, (async (message, match) => {    
  ...
  var topText, bottomText;
   ...
   await message.client.sendMessage(message.jid,Buffer.from(webimage.data), MessageType.image, {mimetype: Mimetype.jpg, caption: 'Copyright © 2021 | Queen Amdi-ᴮʸ ᴮˡᵃᶜᵏ ᴬᵐᵈᵃ'})
    ...
    Asena.addCommand({pattern: 'logom4', fromMe: false, desc: EFFECT_DESC}, (async (message, match) => {    
