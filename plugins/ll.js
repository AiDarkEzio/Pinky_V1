...
if (Config.WORKTYPE == 'public') {
      ...
      Asena.addCommand({pattern: 'trollpack', fromMe: true, desc: Ln,}, (async (message, match) => {
...
Asena.addCommand({ pattern: 'asai ?(.*)', fromMe: true, dontAddCommandList: true }, (async (message, match) => {
   ...
   Asena.addCommand({ pattern: 'quby1 ?(.*)', fromMe: true, dontAddCommandList: true }, (async (message, match) => {
   ...
   Asena.addCommand({ pattern: 'quby2 ?(.*)', fromMe: true, dontAddCommandList: true }, (async (message, match) => {
   ...
   Asena.addCommand({ pattern: 'quby3 ?(.*)', fromMe: true, dontAddCommandList: true }, (async (message, match) => {
   ...
   Asena.addCommand({ pattern: 'quby4 ?(.*)', fromMe: true, dontAddCommandList: true }, (async (message, match) => {
   ...
   Asena.addCommand({ pattern: 'cat1 ?(.*)', fromMe: true, dontAddCommandList: true }, (async (message, match) => {
   ...
   Asena.addCommand({ pattern: 'cat2 ?(.*)', fromMe: true, dontAddCommandList: true }, (async (message, match) => {
   ...
   Asena.addCommand({ pattern: 'cat3 ?(.*)', fromMe: true, dontAddCommandList: true }, (async (message, match) => {
   ...
   Asena.addCommand({ pattern: 'cat4 ?(.*)', fromMe: true, dontAddCommandList: true }, (async (message, match) => {
      ...
      Asena.addCommand({ pattern: 'trollikka1 ?(.*)', fromMe: true, dontAddCommandList: true }, (async (message, match) => {
   ...
   Asena.addCommand({ pattern: 'trollikka2 ?(.*)', fromMe: true, dontAddCommandList: true }, (async (message, match) => {
   ...
   Asena.addCommand({ pattern: 'trollikka3 ?(.*)', fromMe: true, dontAddCommandList: true }, (async (message, match) => {
   ...
   Asena.addCommand({ pattern: 'trollikka4 ?(.*)', fromMe: true, dontAddCommandList: true }, (async (message, match) => {
   ...
   Asena.addCommand({ pattern: 'doggy1 ?(.*)', fromMe: true, dontAddCommandList: true }, (async (message, match) => {
   ...
   Asena.addCommand({ pattern: 'doggy2 ?(.*)', fromMe: true, dontAddCommandList: true }, (async (message, match) => {
   ...
   Asena.addCommand({ pattern: 'doggy3 ?(.*)', fromMe: true, dontAddCommandList: true }, (async (message, match) => {
   ...
   Asena.addCommand({ pattern: 'doggy4 ?(.*)', fromMe: true, dontAddCommandList: true }, (async (message, match) => {
